...
class OrdersTest {
    ...
    void validOrdersTest(String orders) {
        Assertions.assertDoesNotThrow(() -> Orders.create(orders));
    }
    ...
    void invalidFormatOrdersTest(String invalidOrders) {
        Assertions.assertThrows(InvalidOrderFormatException.class, () -> {
    ...
    void onlyDrinkOrdersTest(String onlyDrinkOrders) {
        Assertions.assertThrows(OnlyDrinkOrderException.class, () -> {
